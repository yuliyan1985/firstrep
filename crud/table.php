...
<table>
    ...
    foreach ($number_guess as $row) {
        ...
        echo '<th>' . "<a href='http://php.local/crud/forms.php?action=edit&edit=" .
            $row['id'] . "' class='btn btn-info'>Edit</a> ";

        echo "<a href= http://php.local/crud/forms.php?action=delete&delete=" . $row['id'] . " class='btn btn-danger'>Delete</a>";
        '</th>';
